 ...
 * 作者 ： 于德海
 * 时间 ： 2019/5/10 10:05
 * 描述 ： 对应portalid: 00000003 个人中心
 */
public class Frag_Portal_User extends BasePortalFragment {
    private PortalView imgs[] = new PortalView[8];
    private int top[] = new int[]{0,1,2,3,4};
    private int right[] = new int[]{4,7};
    private int left[] = new int[]{0,5};
    private int last_view_index = 7;
    @Override
    protected int getLayoutId() {
        return R.layout.frag_portal_user;
    }

    @Override
    protected void initView(View view) {
//        LogService.i(TAG,"0000000003 Portal 初始化");
...
//        LogService.i(TAG,"0000000003页面 Portal某一个item对应的id未找到");
        return -1;
    }
